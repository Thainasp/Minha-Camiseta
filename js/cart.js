...
function atualizarCarrinho(){
    ...
    carrinho.forEach((produto,index) =>{
        carrinhoHTML.innerHTML += 
            `<div>
            id='produto${index}' 
            class="d-flex flex-row justify-content-between align-item-center pt-lg-12 pt-mb-12 pt-2 pb-3 border-bottom mobile">
            >
...
function atualizaNumerosTela(qtd, index){
    let qtd = document.getElementById('quantidade' + index);
    qtd.innerHTML = carrinho[item].quantidade
    atualizaTotalProdutos(item);
    atualizaSubtotal();
}

function atualizaTotalProdutos(item){
